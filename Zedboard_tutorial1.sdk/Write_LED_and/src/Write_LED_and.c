 ...
 *section is given a value "false". The two sections are then put through an and gate, and if the
...
int SwitchIn_LEDOut(void)
{
	...
	printf("\nSection 1 AND section 2 gives: %d", and);


	int OutputStatus;

	printf("The LED configuration is: %d. ", and);
	...
	XGpio_DiscreteWrite(&Gpio, LED_CHANNEL, and);
