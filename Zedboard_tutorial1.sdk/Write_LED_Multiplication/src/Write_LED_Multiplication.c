 ...
 * number and the second 4 switches as another decimal number. These two numbers are multiplied
 * together, and the result is displayed on the LEDs.
 ********************************************************************************************/
...
int SwitchIn_LEDOut(void)
{
	...
	printf("Digit 1 x Digit 2 = %d. ", multiplied);

	int OutputStatus;

	printf("The LED configuration is: %d. ", multiplied);
	...
	XGpio_DiscreteWrite(&Gpio, LED_CHANNEL, multiplied);
