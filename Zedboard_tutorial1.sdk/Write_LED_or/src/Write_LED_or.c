 ...
 *section is given a value "false". The two sections are then put through an or gate, and if the
...
int SwitchIn_LEDOut(void)
{
	...
	printf("The LED configuration is: %d. ", or);
	...
	XGpio_DiscreteWrite(&Gpio, LED_CHANNEL, or);
